    ...
    bool continue_on_bad_packet = false)
{
   ...
   // std::cout << "Issuing stream cmd" << std::endl;
    ...
    /////////////////////////////////////////////////////////////////////////
       ...
       for (unsigned i = 15; i < buff3.size(); ++i)
             buff4[i]=(buff3[i-15]+buff3[i-14]+buff3[i-13]+buff3[i-12]+buff3[i-11]+buff3[i-10]+buff3[i-9]+buff3[i-8]+buff3[i-7]+buff3[i-6]+buff3[i-5]+buff3[i-4]+buff3[i-3]+buff3[i-2]+buff3[i-1]+buff3[i])/16.0;
  ...
  int UHD_SAFE_MAIN(int argc, char* argv[])
{
   ...
   double rcv_rate;
    ...
    std::ofstream myfile;
    myfile.open("../../../data_benchmark_cpp_mean16_L0.txt");
