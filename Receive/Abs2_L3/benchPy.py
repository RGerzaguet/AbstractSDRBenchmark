...
def benchmark_rx_rate(usrp, rx_streamer, timer_elapsed_event, rx_statistics,flag,recv_buffer,fft_buffer,abs_buffer,fft_plan):
...
def main():
    ...
    f = open("../data_benchmark_python_abs2_L3.txt", "w")
        ...
        for mt in range(1,montecarlo_num+1):
            ...
            rx_thread = threading.Thread(target=benchmark_rx_rate,
                                        args=(usrp, rx_streamer, quit_event,
                                            rx_statistics,flag,recv_buffer,fft_buffer,abs_buffer,fft_plan))
